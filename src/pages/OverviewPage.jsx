...
export default function OverviewPage() {
  ...
  const dashboard = useMemo(() => {
    ...
    return {
      ...
      actions: [
        { label: "Add Course", to: "/dashboard/add-course", icon: Plus, tone: "primary" },
        { label: "Add Internship Plan", to: "/dashboard/internships/add", icon: Briefcase, tone: "teal" },
        { label: "Add Testimonial", to: "/dashboard/testimonials/add", icon: Plus, tone: "teal" },
        { label: "Add FAQ", to: "/dashboard/faqs/add", icon: Plus, tone: "violet" },
      ],
      activity: [
        {
          tone: "blue",
      ...
      distribution: [
        { label: "Courses", value: courses.length, to: "/dashboard/courses", tone: "courses" },
        { label: "Internships", value: internships.length, to: "/dashboard/internships", tone: "internships" },
        { label: "FAQs", value: faqs.length, to: "/dashboard/faqs", tone: "faqs" },
        { label: "Testimonials", value: testimonials.length, to: "/dashboard/testimonials", tone: "testimonials" },
      ],
      manage: [
        { label: "Manage Courses", to: "/dashboard/courses", icon: BookOpen },
        { label: "Manage Internships", to: "/dashboard/internships", icon: Briefcase },
        { label: "Manage FAQs", to: "/dashboard/faqs", icon: CircleHelp },
        { label: "Manage Testimonials", to: "/dashboard/testimonials", icon: MessageSquareQuote },
      ],
      searchIndex: [
        ...courses.map((item) => ({
          id: `course-${item.slug}`,
          ...
          to: `/dashboard/courses/${item.slug}`,
          type: "Course",
        })),
        ...
        ...faqs.map((item) => ({
          ...
          to: `/dashboard/faqs/${item.slug}/edit`,
          type: "FAQ",
        })),
        ...testimonials.map((item) => ({
          ...
          to: `/dashboard/testimonials/${item.slug}`,
          type: "Testimonial",
        })),
      ],
    };
